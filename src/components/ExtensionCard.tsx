...
import { FaCheck, FaClock, FaDownload, FaInfoCircle, FaStar } from "react-icons/fa";
import Spinner from "./Spinner";

const ExtensionCard = React.memo(({ ext, formatDate, onInfoClick, onDownloadClick }: { 
  ext: CardItem; 
